...
# D1: 货币政策 - FOMC 6/17 决议: 利率不变 3.50-3.75%, 但鹰派转向
# Warsh 首秀: 删除"宽松倾向", dot plot 9/18 预测加息, 中位数升至 3.8%
# 10月加息概率 60-86%, 2Y收益率飙升14bp
# 基础分 0.32 (紧缩+加息预期)
D1_BASE = 0.32

# D2: 经济周期 - GDP 2.2-2.7%, ISM 54.0, NFP +172K, 失业率 4.3%
# 经济韧性好但加息预期压制, PCE预估从2.7%上调至3.6%
# 基础分 0.55 (扩张但货币政策逆风)
D2_BASE = 0.55
...
# D11: 市场情绪 - FOMC后暴跌: Dow -500, S&P -1.2%, SOX -5.7%
# VIX飙升, 10Y收益率4.49%, 黄金跌1.77%, 加息恐慌
# 基础分 0.35 (恐慌)
D11_BASE = 0.35
...
# 基于行业研究数据
D4_INDUSTRY = {
    # 半导体: SOX -5.7%, FOMC加息恐慌重创高估值
    'semi': 0.45,
    # 科技巨头: 通信-2.98%, 科技-2.3%, 加息预期最受伤
    'tech': 0.48,
    # 加密相关: 风险资产全面承压
    'crypto': 0.50,
    'crypto_native': 0.52,
    # 金融/支付: 加息预期利好净息差, 但市场普跌
    'financial': 0.55,
    # 消费: 防御性相对抗跌
    'consumer': 0.50,
    # 工业/国防: 地缘政治支撑
